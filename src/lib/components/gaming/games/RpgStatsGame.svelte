...
<div class="w-full h-full p-4 sm:p-6 flex flex-col justify-between select-text font-mono text-xs text-purple-300">
	<div class="flex items-center justify-between px-3 py-2 bg-zinc-900/80 rounded-xl border border-zinc-800 select-none">
		...
		<div class="flex items-center gap-3">
			<span class="px-2 py-0.5 rounded bg-purple-950/60 border border-purple-500/40 text-[10px] text-purple-300 font-bold">
				LVL 24 WARRIOR
			</span>
			<button
				type="button"
	...
	<div class="grid grid-cols-1 md:grid-cols-12 gap-4 my-auto">
		<div class="md:col-span-4 p-4 rounded-2xl bg-zinc-900/80 border border-purple-500/30 space-y-3 text-center select-none">
			<div class="w-24 h-24 mx-auto rounded-2xl overflow-hidden border-2 border-purple-400 shadow-lg shadow-purple-500/20">
		...
		<div class="md:col-span-8 p-4 sm:p-5 rounded-2xl bg-zinc-900/80 border border-purple-500/30 space-y-4 flex flex-col justify-between">
			<div class="flex items-center gap-2 border-b border-purple-500/20 pb-2 select-none">
				<button
					...
					class={`px-3 py-1 rounded-lg text-[11px] font-bold uppercase transition-colors cursor-pointer ${
						activeTab === 'attributes' ? 'bg-purple-500 text-black' : 'hover:bg-zinc-800 text-zinc-400'
					}`}
				>
					Attributes
				</button>
				<button
					...
					class={`px-3 py-1 rounded-lg text-[11px] font-bold uppercase transition-colors cursor-pointer ${
						activeTab === 'equipment' ? 'bg-purple-500 text-black' : 'hover:bg-zinc-800 text-zinc-400'
					}`}
				>
					Equipment
				</button>
			...
			<div class="flex-1 overflow-y-auto">
				{#if activeTab === 'attributes'}
					<div class="space-y-2.5">
						<div class="flex items-center justify-between p-2 rounded-xl bg-black/40 border border-zinc-800">
				...
				{:else if activeTab === 'equipment'}
					<div class="space-y-2 text-[11px]">
						<div class="p-2.5 rounded-xl bg-black/40 border border-zinc-800 space-y-0.5">
							...
							<div class="text-zinc-400 text-[10px]">+45 Speed &bull; Pure Wayland Compositor Ricing</div>
						</div>
						<div class="p-2.5 rounded-xl bg-black/40 border border-zinc-800 space-y-0.5">
							<div class="font-bold text-cyan-300">ARMOR: Tailwind CSS v4 Reactive Mail</div>
							<div class="text-zinc-400 text-[10px]">+50 Agility &bull; Zero config atomic styling</div>
						</div>
						<div class="p-2.5 rounded-xl bg-black/40 border border-zinc-800 space-y-0.5">
							<div class="font-bold text-rose-300">RELIC: Ring of Svelte 5 Runes</div>
							<div class="text-zinc-400 text-[10px]">+60 Reactivity &bull; Ultra low bundle footprint</div>
						</div>
					</div>
				{:else if activeTab === 'skills'}
					<div class="space-y-2 text-[11px]">
						<div class="p-2.5 rounded-xl bg-black/40 border border-zinc-800 space-y-0.5">
							...
							<div class="text-zinc-400 text-[10px]">C# .NET WPF desktop applications with instant UI responsiveness.</div>
						</div>
						<div class="p-2.5 rounded-xl bg-black/40 border border-zinc-800 space-y-0.5">
							<div class="font-bold text-emerald-300">Full-Stack Synthesis</div>
							<div class="text-zinc-400 text-[10px]">End-to-end integration spanning TypeScript, SvelteKit, APIs, and SQL.</div>
						</div>
					</div>
				{/if}
			</div>
